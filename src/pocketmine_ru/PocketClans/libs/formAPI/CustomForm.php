...
namespace pocketmine_ru\PocketClans\libs\formAPI;
...
class CustomForm extends Form {
    ...
    public function addLabel(string $text, mixed $label = null): void {
        $this->addContent(["type" => "label", "text" => $text]);
        $this->labelMap[] = $label ?? count($this->labelMap);
        $this->validationMethods[] = static fn($v) => $v === null;
    }

    public function addToggle(string $text, bool $default = null, mixed $label = null): void {
    ...
    public function addSlider(string $text, int $min, int $max, int $step = -1, int $default = -1, mixed $label = null): void {
    ...
    public function addStepSlider(string $text, array $steps, int $defaultIndex = -1, mixed $label = null): void {
    ...
    public function addDropdown(string $text, array $options, int $default = null, mixed $label = null): void {
        $this->addContent(["type" => "dropdown", "text" => $text, "options" => $options, "default" => $default]);
        $this->labelMap[] = $label ?? count($this->labelMap);
        $this->validationMethods[] = static fn($v) => is_int($v) && isset($options[$v]);
    }

    public function addInput(string $text, string $placeholder = "", mixed $default = null, mixed $label = null): void {
